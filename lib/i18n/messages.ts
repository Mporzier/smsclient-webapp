...
const fr = {
  ...
  "parametres.card.contact-facturation.description":
    "Adresse email pour la réception des factures.",
  ...
  "parametres.saveSection.entreprise": "Enregistrer l'entreprise",
  "parametres.saveSection.smsAlertes": "Enregistrer SMS et alertes",
  "parametres.savedToast": "Modifications enregistrées.",
  "parametres.unsavedHint": "{count} modification(s) non enregistrée(s)",
  ...
  "parametres.businessActivity.empty": "Aucun secteur sélectionné",
  "parametres.businessActivity.choose": "Choisir",
  "parametres.businessActivity.change": "Modifier",
  "parametres.businessActivity.modalTitle": "Secteur d'activité",
  "parametres.businessActivity.modalDescription":
    "Choisissez votre secteur puis votre type d'activité.",
  ...
  "parametres.field.billingContactPlaceholder": "Ex. facturation@entreprise.fr",
  "parametres.field.siretInvalid": "SIRET invalide (14 chiffres).",
  "parametres.field.tvaInvalid": "Numéro de TVA invalide.",
  "parametres.field.zipInvalid": "Code postal invalide pour ce pays.",
  "parametres.field.billingContactInvalid": "Format d'email invalide.",
...
const en: Record<MessageKey, string> = {
  ...
  "parametres.saveSection.entreprise": "Save company",
  "parametres.saveSection.smsAlertes": "Save SMS & alerts",
  "parametres.savedToast": "Changes saved.",
  "parametres.unsavedHint": "{count} unsaved change(s)",
  ...
  "parametres.businessActivity.empty": "No industry selected",
  "parametres.businessActivity.choose": "Choose",
  "parametres.businessActivity.change": "Change",
  "parametres.businessActivity.modalTitle": "Industry",
  "parametres.businessActivity.modalDescription":
    "Choose your industry, then your business type.",
  "parametres.field.siret": "SIRET",
  ...
  "parametres.field.billingContactPlaceholder": "Ex. billing@company.com",
  "parametres.field.siretInvalid": "Invalid SIRET (14 digits).",
  "parametres.field.tvaInvalid": "Invalid VAT number.",
  "parametres.field.zipInvalid": "Invalid postal code for this country.",
  "parametres.field.billingContactInvalid": "Invalid email format.",
