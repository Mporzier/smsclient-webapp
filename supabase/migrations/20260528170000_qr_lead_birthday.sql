-- Capture QR : enregistrement optionnel de la date d'anniversaire.

drop function if exists public.submit_qr_lead(text, text, text, text, boolean);
...
begin
  ...
  do update set
    ...
    source = 'QR boutique',
    birthday = coalesce(excluded.birthday, public.clients.birthday);
